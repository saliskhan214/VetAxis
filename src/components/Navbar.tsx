        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          >
            ...
            <motion.button
              ...
              className="flex items-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-[#5a5a40] text-white font-extrabold text-xs sm:text-sm border border-[#3e3e2b] border-b-[3px] border-b-[#2a2a1d] shadow-sm hover:bg-[#3e3e2b] transition-all cursor-pointer"
        ...
        {isSidebarOpen && (
          <div className="fixed inset-0 z-[300]">
            ...
            >
              ...
              {/* Bottom Region (Profile & Signout OR Guest Sign In) */}
              <div className="p-5 border-t border-[#f4f1e9] bg-[#fcf9f2]/90 flex flex-col gap-4">
                {user ? (
                  ...
                  <>
                    <p className="text-[10px] uppercase font-bold text-[#a49f92] tracking-wider">Guest Visitor</p>
                    <div className="p-3.5 bg-white rounded-2xl border border-[#e3dec9] border-b-[3px] border-b-[#cdc6ad] flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#5a5a40] text-white flex items-center justify-center text-lg font-bold shadow-xs">
                        🐾
                      </div>
                      <div className="text-left flex-1 min-w-0">
                        <h5 className="font-bold text-xs text-stone-900 leading-tight">Welcome Visitor</h5>
                        <p className="text-[10px] text-stone-500 truncate">Browsing open clinical directory</p>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-3.5 px-4 rounded-xl bg-[#5a5a40] text-white font-black text-xs shadow-md border-b-[3px] border-b-[#3e3e2b] hover:bg-[#3e3e2b] transition-all cursor-pointer flex items-center justify-center gap-2"
                    >
                      <span>🔐</span>
